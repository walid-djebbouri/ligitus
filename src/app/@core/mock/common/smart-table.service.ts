...
export class SmartTableService extends SmartTableData {
    ...
    getCabinetByPage(pageNumber: number, selectedState: string): Observable<any> {
        return this.http.get(environment.apiUrl + '/cabinetv2/' + pageNumber + '/batchnumber/750/maxbatch/20/recbatch/'
            + selectedState + '/wilayacode/[0-9a-zA-Z]/cabinetname').
        pipe(
            map((cabinet: any[]) => {
